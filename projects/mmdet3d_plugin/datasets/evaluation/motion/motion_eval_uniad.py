...
from .motion_utils import MotionBox, accumulate, load_gt, load_prediction
...
class MotionEval:
    ...
    def __init__(
        ...
        self.gt_boxes = load_gt(
            self.nusc, self.eval_set, MotionBox, verbose=verbose, seconds=seconds
        )
