...
from nuscenes.eval.common.utils import (Quaternion, attr_acc, center_distance,
                                        cummean, quaternion_yaw, scale_iou,
...
from nuscenes.eval.detection.constants import (ATTRIBUTE_NAMES,
                                               DETECTION_NAMES, TP_METRICS)
from nuscenes.eval.detection.data_classes import (DetectionBox,
                                                  DetectionConfig,
                                                  DetectionMetricData,
                                                  DetectionMetricDataList,
                                                  DetectionMetrics)
from nuscenes.eval.detection.render import (class_pr_curve, class_tp_curve,
                                            dist_pr_curve, summary_plot,
                                            visualize_sample)
...
def load_gt(
    nusc: NuScenes, eval_split: str, box_cls, verbose: bool = False, seconds: int = 12
) -> EvalBoxes:
    """
        ...
        for sample_annotation_token in sample_annotation_tokens:
            ...
            if box_cls == MotionBox:
                ...
                fut_traj_local = predict_helper.get_future_for_agent(
                    instance_token, sample_token, seconds=seconds, in_agent_frame=True
                )
...
def accumulate(
    ...
    match_data = {"conf": [], "min_ade": [], "min_fde": [], "miss_rate": []}
