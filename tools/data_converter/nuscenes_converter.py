...
from projects.mmdet3d_plugin.datasets.map_utils.nuscmap_extractor import \
    NuscMapExtractor
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        if not test:
            ...
            valid_flag = np.array(
                ...
                -1
            )  ## TODO update valid flag for tracking
            ...
            for i, anno in enumerate(annotations):
                ...
                if fut_traj_local.shape[0] > 0:
                    ...
                    gt_fut_trajs[i, 1:valid_step] = (
                        fut_traj_scene[1:] - fut_traj_scene[:-1]
                    )
...
def get_ego_status(nusc, nusc_can_bus, sample):
    ...
    try:
        ...
        ego_status.extend(
            pose_data["accel"]
        )  # acceleration in ego vehicle frame, m/s/s
        ego_status.extend(
            pose_data["rotation_rate"]
